    ...
    <div>
      ...
      <div id='ready'>
        <div className='' style={{marginTop: '5%'}}>
              <h1 className=''>Bem-vindo {username} ao quiz iniciante!</h1><br/>
      ...
      <Button href='/score-minor' style={{backgroundColor: '#01d976', borderColor: '#01d976', fontWeight: 'bold'}} className='rounded-pill col-md-2 button-user'>Ver Ranking</Button><br/><br/>
