            ...
            <div style={{padding: '5px 45px 15px 45px'}}>
                ...
                .map((scores, index) => (
                  <tr  key={index} style={{border: '2px solid #01d976', color: 'white'}}>
                    ...
                    <td style={{border: '2px solid #01d976', color: (username === scores.username ? '#01d976' : 'white'), backgroundColor: (index ? "" : "red"), fontWeight: (username === scores.username ? "bold" : "")}}>{scores.score ? "Quiz Iniciante" : "Quiz Avançado"}</td>
